...
class HeightMap
{
	...
	Shader* shader_normalsdraw = nullptr;
...
public:
	...
	HeightMap(std::string texture_path, const char* shadersFolderPath)
	{
		...
		shader = new Shader(path_shader_mesh_vert.c_str(), path_shader_mesh_frag.c_str(), path_shader_mesh_geom.c_str());
		shader_normalsdraw = new Shader(path_shader_normals_vert.c_str(), path_shader_normals_frag.c_str(), path_shader_normals_geom.c_str());
